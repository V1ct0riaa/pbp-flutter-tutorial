...
import 'dart:convert';
import 'package:lab6app/model/to_do.dart';
import 'package:lab6app/main.dart';
import 'package:lab6app/page/form.dart';
...
class _ToDoPageState extends State<ToDoPage> {
  Future<List<ToDo>> fetchToDo() async {
    ...
    // Converts JSON data to ToDo object
    List<ToDo> listToDo = [];
    for (var d in data) {
      if (d != null) {
